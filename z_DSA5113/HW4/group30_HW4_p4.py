...
for i in range(1,k+1):
    ...
    while done == 0:
        ...
        print(f"Solution {solutionsChecked}, k = {i}")

print ("\nFinal number of solutions checked: ", solutionsChecked)
print ("Best value found: ", abs_best[0])
print ("Weight is: ", abs_best[1])
print ("Total number of items selected: ", np.sum(abs_sol))
print ("Best solution: ", abs_sol)
